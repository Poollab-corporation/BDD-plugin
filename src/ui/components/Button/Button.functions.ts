    ...
    case 'primary':
      switch (style) {
        case 'fill-strong':
          ...
          boxShadow = `0px 2px 14px 0px rgba(98, 159, 255, 0.60)`
        ...
        case 'line':
          ...
          border = ({ theme }: StyleProps) =>
            `1px solid ${theme.colors.neutralGray200}`
          color = ({ theme }: StyleProps) => theme.colors.blue500
          break
        case 'mono':
    ...
    case 'warning':
      switch (style) {
        case 'fill-strong':
          ...
          boxShadow = `0px 2px 14px 0px rgba(255, 91, 70, 0.60);`
          color = ({ theme }: StyleProps) => theme.colors.white
          break
        case 'fill-weak':
    ...
    case 'primary':
      switch (style) {
        case 'fill-strong':
          ...
          boxShadow = `0px 2px 14px 0px rgba(34, 117, 248, 0.60)`
          break
        case 'fill-weak':
    ...
    case 'warning':
      switch (style) {
        case 'fill-strong':
          ...
          boxShadow = `0px 2px 14px 0px rgba(252, 57, 37, 0.60)`
          break
        case 'fill-weak':
